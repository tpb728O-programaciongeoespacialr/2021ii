...
La función [write_raster()](https://rdrr.io/cran/terra/man/writeRaster.html) guarda en el disco un objeto ```SpatRaster``` en los diferentes [formatos raster de GDAL](https://gdal.org/drivers/raster/).
